...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.personal.djb.catmovie/files/databases/";
	//	模拟器用
//	private static String DB_PATH = "/data/data/com.personal.djb.catmovie/databases/";
