 ...
 */
public class AmericaMovieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements StickyRecyclerHeadersAdapter {

    private AmericaMovieBean bean;
    //  美国电影的列表
    private List<AmericaMovieBean.DataBean.ComingBean> datas;
    ...
    public AmericaMovieAdapter(Context context, AmericaMovieBean datas){
        this.context = context;
        this.bean = datas;
        this.datas = datas.getData().getComing();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeadViewHolder) {
            ((AmericaMovieAdapter.HeadViewHolder)holder).setData();
        } else if (holder instanceof ViewHolder) {
            ((AmericaMovieAdapter.ViewHolder)holder).setData(position - 1);
        }
    }
    ...
    public void setDatas(AmericaMovieBean bean) {
        this.bean = bean;
        datas.clear();
        datas.addAll(this.bean.getData().getComing());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            AmericaMovieBean.DataBean.ComingBean comingBean = datas.get(position);
            //  替换为可以访问的图片
            ...
            //  1.判断3d
            if (comingBean.getVer() != null && comingBean.getVer().length()>2) {
            ...
            mHotMovieTitleDesc.setText("美国待映");
...
//            }
        ...
        //  预售
        private void setWaitNoPlayMovie(AmericaMovieBean.DataBean.ComingBean comingBean) {
            mHotMovieBtnOrder.setVisibility(View.VISIBLE);
            mHotMovieBtnWant.setVisibility(View.GONE);
        }

        //  想看
        private void setWantPlayMovie(AmericaMovieBean.DataBean.ComingBean comingBean) {
    ...
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (getHeaderId(position) == 2) {
            ...
            commonTitle.setText("美国热映");
        } else if (getHeaderId(position) == 3){
            commonTitle.setText("美国待映");
