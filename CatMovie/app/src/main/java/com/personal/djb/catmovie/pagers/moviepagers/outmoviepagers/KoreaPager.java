...
import com.personal.djb.catmovie.adapter.outmovieadapter.KoreaMovieAdapter;
...
public class KoreaPager extends BasePager {
     ...
     * 适配器
     */
    private KoreaMovieAdapter adapter;
    ...
    private void getDataFromNet() {
        ...
        RequestCall call = OkHttpUtils.get().url(KOREA_MOVIE_URL).build();
...
//                Log.e("xxx", AMERICA_MOVIE_URL);
    ...
    private void processData(String json) {
        ...
        KoreaMovieBean koreaMovieBean = new Gson().fromJson(json, KoreaMovieBean.class);
        datas = koreaMovieBean;
    ...
    private void setView() {
        ...
        adapter = new KoreaMovieAdapter(context,datas);
        //设置布局管理器
