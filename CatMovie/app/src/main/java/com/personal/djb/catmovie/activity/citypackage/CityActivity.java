package com.personal.djb.catmovie.activity.citypackage;
...
public class CityActivity extends Activity implements AbsListView.OnScrollListener {
    ...
    public static final int RECUALT_CITY_CODE = 2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //  返回按钮
        mBtnForBack = (ImageButton) findViewById(R.id.ib_yk_forback);
        ...
        personList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    ...
                    setResult(RECUALT_CITY_CODE, intent);
                    finish();
...
//        option.setScanSpan(100000); // 10分钟扫描1次
...
//            option.setPriority(LocationClientOption.GpsFirst);
    ...
    private void getResultCityList(String keyword) {
        DBHelper dbHelper = new DBHelper(this);
        try {
//            String pingYin = PinyinTool.getPingYin(keyword);
//            char[] chars = pingYin.toCharArray();
//            String search = "";
...
//            }
            ...
            String sea1 = "select * from city where name like \"%" + keyword
                    + "%\" or pinyin like \"%" + keyword + "%\"";
//            String sea2 = "select * from city where name like"+search;
            dbHelper.createDataBase();
            SQLiteDatabase db = dbHelper.getWritableDatabase();
            Cursor cursor = db.rawQuery(
                    sea1, null);
    ...
    private class ResultListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.my_city_list_item, null);
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (viewType == 0) { // 定位
                convertView = inflater.inflate(R.layout.my_city_frist_list_item, null);
                ...
                convertView = inflater.inflate(R.layout.my_city_recent_city, null);
...
//                                .show();
                ...
                convertView = inflater.inflate(R.layout.my_city_total_item, null);
            } else {
                if (convertView == null) {
                    convertView = inflater.inflate(R.layout.my_city_list_item, null);
    ...
    class HotCityAdapter extends BaseAdapter {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = inflater.inflate(R.layout.my_city_item_city, null);
    ...
    private void initOverlay() {
        ...
        overlay = (TextView) inflater.inflate(R.layout.my_city_overlay, null);
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if (mReady) {
            ...
            if (firstVisibleItem < 4) {
                ...
                text = PinyinTool.converterToFirstSpell(pinyin)
