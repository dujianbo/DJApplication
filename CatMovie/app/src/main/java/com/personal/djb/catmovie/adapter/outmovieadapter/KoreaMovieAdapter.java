...
import com.personal.djb.catmovie.bean.movies.outmoviebean.KoreaMovieBean;
 ...
 */
public class KoreaMovieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private KoreaMovieBean bean;
    //  美国电影的列表
    private List<KoreaMovieBean.DataBean.HotBean> datas;
    ...
    public KoreaMovieAdapter(Context context, KoreaMovieBean datas){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeadViewHolder) {
            ((KoreaMovieAdapter.HeadViewHolder)holder).setData();
        } else if (holder instanceof ViewHolder) {
            ((KoreaMovieAdapter.ViewHolder)holder).setData(position - 1);
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            KoreaMovieBean.DataBean.HotBean comingBean = datas.get(position);
            //  替换为可以访问的图片
            ...
            if (getLayoutPosition() == 1) {
                mHotMovieTitleDesc.setText("韩国热映");
            ...
            List<KoreaMovieBean.DataBean.HotBean.HeadLinesVOBean> headLinesVO = comingBean.getHeadLinesVO();
        ...
        //  预售
        private void setWaitNoPlayMovie(KoreaMovieBean.DataBean.HotBean comingBean) {
            mHotMovieBtnOrder.setVisibility(View.VISIBLE);
            mHotMovieBtnWant.setVisibility(View.GONE);
        }

        //  想看
        private void setWantPlayMovie(KoreaMovieBean.DataBean.HotBean comingBean) {
